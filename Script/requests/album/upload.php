            ...
            if ($fetch['count'] == 1)
            {
                ...
                for ($i = 0; $i < $photosCount; $i++)
                {
                    ...
                    if (! empty($photoData['id']))
                    {
                        ...
                        $themeData['list_photo_story_id'] = $mediaPostId;
                        ...
                        $html .= \SocialKit\UI::view('album/list-photo-each');
                    }
                }
                ...
                $activityText = '@added_' . $photosCount . '_new_photos_to_album@ [album]' . $albumId . '[/album]';
